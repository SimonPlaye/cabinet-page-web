    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-white/80 backdrop-blur-sm shadow-lg sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-primary">Droit de la famille</h1>
      ...
      <main className="flex-grow container mx-auto px-4 py-20">
        <Card className="max-w-3xl mx-auto">
          <CardContent className="p-6">
            ...
            <h2 className="text-2xl font-semibold mb-4 text-center">Droit de la famille</h2>
            <p className="text-gray-700 mb-4">
              Notre cabinet est spécialisé dans tous les aspects du droit de la famille, offrant des conseils et une représentation dans des domaines tels que :
            </p>
            ...
            <p className="text-gray-700">
              Nous comprenons la nature sensible des affaires familiales et nous nous efforçons d&apos;offrir un soutien compatissant et des solutions pratiques à nos clients pendant ces périodes difficiles.
            </p>
          </CardContent>
        </Card>
      </main>
