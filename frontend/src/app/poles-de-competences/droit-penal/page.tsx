...
const competences = [
  { title: "Droit de la famille", icon: Users, href: "/poles-de-competences/droit-de-la-famille" },
  { title: "Droit des successions", icon: Briefcase, href: "/poles-de-competences/droit-des-successions" },
  { title: "Droit pénal", icon: Scale, href: "/poles-de-competences/droit-penal" },
];
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-white/80 backdrop-blur-sm shadow-lg sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-primary">Nos pôles de compétences</h1>
